...
public sealed class JunkStormUnityController : MonoBehaviour
{
                ...
                else
                {
                    foreach (var targetIndex in targets)
                    {
                        ...
                        CreateButton(controlRoot, $"Attack {game.Players[targetIndex].Name} with Soldier", () =>
                        {
                            ...
                            Render();
                        }, true, $"Attack {game.Players[targetIndex].Name} — Destroy Soldier to attack another player at your Location. If undefended, steal 1 random card from their hand.");
                    }
                }
            }
    ...
    private void AssignExpeditionWorker(int outpostIndex)
    {
        ...
        if (limit <= 0)
        {
            SetInfo($"{game.ActivePlayer.Name} has no available workers to send.");
            return;
        }
    ...
    private void ConfirmExpedition()
    {
        ...
        {
            SetInfo("Choose a Location and assign at least 1 worker.");
            return;
        }
    ...
    private string GetCardTooltip(string cardName)
    {
        ...
        var notes = cardName switch
        {
            ...
            "Soldier" => "Destroy: cancel a Biodomer attack, attack another player at your Location, or defend against a Soldier attack at your Location.",
