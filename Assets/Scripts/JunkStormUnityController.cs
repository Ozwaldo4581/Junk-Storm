...
public sealed class JunkStormUnityController : MonoBehaviour
{
    ...
    private static readonly RulebookSection[] RulebookSections =
    {
        ...
        new RulebookSection("Expedition Phase", "In turn order, each player chooses a destination and sends worker tokens up to current Clout, never more than they own. Players may visit a valid Outpost, the Biodome if they meet requirements, or the Wilderness.\n\nPlayers cannot choose an Outpost occupied by the Junk Storm or Biodomers.\n\nOutpost Expedition: draw 1 scavenge card from that Outpost deck per worker token sent. Event cards resolve immediately and are destroyed. Non-event cards go to discard unless a bonus changes that.\n\nBiodome Expedition requires at least 5 Clout and 5 worker tokens. Lose 5 workers, lose 5 Clout not below 1, and draw 1 Special card.\n\nWilderness has no scavenge deck. You cannot be targeted by Attack cards or use Defense cards, but remain vulnerable to hazards."),
        ...
        new RulebookSection("Junk Storm Phase", "Roll 1d10. On 1–5, move the Junk Storm. On 6–10, move the Biodomers. Odd rolls move counterclockwise; even rolls move clockwise. Junk Storm moves spaces equal to the roll. Biodomers move spaces equal to the roll minus 5.\n\nJunk Storm affects every Outpost it passes over, including where it lands. Destroy the top card of each affected Outpost deck. Players at affected Outposts destroy the top card of their deck, lose all expedition workers, and lose 1 Clout per worker lost. Storm Shield can cancel this.\n\nBiodomers attack players where they land. An attacked player loses 2 worker tokens and 1 Clout per worker lost. Soldier or Weapon Outfitting can cancel this."),
